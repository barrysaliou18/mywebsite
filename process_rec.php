...
$db 	= "recreg";
$query	= "INSERT into $db (name,empid,hospid,city,phone,bloodgrp,rh) VALUES ('" . $name . "','" . $empid . "','" . $hospid . "','" . $city . "','" . $phone . "','" . $bloodgrp . "','" . $rh . "')";
...
echo "Here is the list of available donors matching your blood type! <br><br>";
 $sql 	="SELECT * FROM donreg where bloodgrp='" . $bloodgrp . "' and rh='" . $rh . "' ";
